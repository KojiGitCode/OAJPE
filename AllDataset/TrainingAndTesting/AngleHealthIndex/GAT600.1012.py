        ...
        def process(self):
            if os.path.exists(os.path.join(temp, "data", "processed", "datas.pt")):
                ...
                if   int(args_Ainx) == 0:
                    ...
                    ### GitHub ###
                    LBL0   = np.genfromtxt(os.path.join(file_path22, 'Labels_GCN.AngleDiff1012.inx.csv'),  delimiter=',') #Amax Bet. Buses 10-12
                    #BL0   = np.genfromtxt(os.path.join(file_path22, 'Labels_GCN.AngleDiff1049.inx.csv'),  delimiter=',') #Amax Bet. Buses 10-49
                    ### GitHub ###
...
def Pref_Close(Flag):
    ...
    if Flag == 1:
        ...
        ### For GitHub ###
        np.save(os.path.join(temp, 'MdlType.npy'),        np.array(5))     # GNN Model Type for Angle between Buses 10-12
        #p.save(os.path.join(temp, 'MdlType.npy'),        np.array(6))     # GNN Model Type for Angle between Buses 10-49
        ### For GitHub ###
...
#niFname = "GAT4H2LR.0001Enc1.pth" # For Angle Buses 10-49
