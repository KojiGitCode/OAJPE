...
if   args.mdl == "GCN5":
    ...
    if args.enc == "Y":
        file_pathML = os.path.join(os.getcwd(),'Sample_Datasets','Angl','ENN32BNN64GAT4H2LR.0001Enc1.pth')
    else:
        file_pathML = os.path.join(os.getcwd(),'Sample_Datasets','Angl','ENN32BNN64GAT4H2LR.0001Enc0.pth')
    np.save(os.path.join(os.getcwd(),'Sample_Datasets','tmp_files', 'EdgeNeuron.npy'), np.array(32)) # Number of Neurons for Edges
